# PIP CRM — App Scope (Updated After Employee Relations AI + Document-Type Prefill Phase)
...
Planned next ER scope:
- optional choice between plain and AI-prefilled drafts
- smarter per-document-type draft sections/wording refinement
- possible policy file text extraction into ER policy text records
- tighter document composition for specific letter styles
...
- the next logical development phase is ER document workflow refinement rather than basic ER AI enablement
