# PIP CRM — Architecture (Updated After Employee Relations AI + Document-Type Prefill Phase)
...
3. refine ER document workflow next
4. add optional plain-vs-AI draft choice
5. consider policy file extraction later
6. revisit deeper architectural refactor only if explicitly approved later

This is the correct architecture baseline after the Employee Relations AI + document-type prefill phase.
