...
- introduce organisation-aware tenancy foundation
- link users to organisations
- resolve module settings by current user organisation instead of a single default organisation
- prepare admin settings and dashboards to become organisation-scoped
- define a safe migration path for organisation ownership across employees, cases, documents, AI logs, and API keys
- preserve existing routes and additive development while preparing for full tenant isolation

## Phase 3 — Module packaging foundation
